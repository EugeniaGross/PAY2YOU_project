  ...
  return (
    <div className={PageStyles.page_wrapper}>
      ...
      <section className={PageStyles.bottomNavWrapper}>
        ...
        <a onClick={() => setSnackbarOpen(true)}>
          Как пользоваться?
          <Modal
            open={snackbarOpen}
            ...
            showButton={true}
            buttonText={"Понятно"}
            buttonBackgroundColor={variables.mainBackgroundColor}
            buttonBorderColor={variables.buttonBorderColor}
            buttonTextColor={variables.mainTextFontColor}
          />
        </a>
      </section>
    </div>
